    ...
    <main className="bg-[#0F172A] text-white min-h-screen">
      <div className="max-w-4xl mx-auto px-6 py-20 space-y-16">
        ...
        <section className="space-y-6">
          <h1 className="text-4xl font-bold tracking-tight">Electrotrack</h1>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mt-8">
            <div className="space-y-2 text-sm">
              ...
              <ul className="space-y-1 text-gray-400">
                <li><strong className="text-gray-300">Frontend:</strong> Next.js 15.2.4 (App Router), TypeScript</li>
                <li><strong className="text-gray-300">UI:</strong> Tailwind CSS, shadcn/ui, Lucide Icons</li>
                <li><strong className="text-gray-300">Database:</strong> MongoDB</li>
                <li><strong className="text-gray-300">Authentication:</strong> NextAuth.js, Google OAuth, bcryptjs</li>
                <li><strong className="text-gray-300">Payment:</strong> Razorpay</li>
                <li><strong className="text-gray-300">Email:</strong> Nodemailer (Gmail SMTP)</li>
              </ul>
            </div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <ul className="space-y-1 text-gray-400">
                ...
                <li><strong className="text-gray-300">GitHub:</strong> <a href="https://github.com/Yash-109/Electrotrack" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">Yash-109/Electrotrack</a></li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Product Catalog & Filtering</h3>
              <p className="text-gray-400 text-sm">Browse electronics with advanced filtering and search capabilities.</p>
            </div>

            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Shopping Cart with Persistence</h3>
              <p className="text-gray-400 text-sm">Local storage-based cart that persists across sessions.</p>
            </div>

            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Razorpay Integration</h3>
              <p className="text-gray-400 text-sm">Secure payment processing with Razorpay checkout.</p>
            </div>

            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Google OAuth Login</h3>
              <p className="text-gray-400 text-sm">One-click authentication with Google accounts via NextAuth.js.</p>
            </div>

            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Admin Dashboard</h3>
              <p className="text-gray-400 text-sm">Revenue analytics, transaction monitoring, and order management.</p>
            </div>

            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Contact Form</h3>
              <p className="text-gray-400 text-sm">Nodemailer-powered email notifications for customer inquiries.</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2 text-blue-400">Full Authentication Flow</h3>
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2 text-blue-400">Responsive E-commerce UI</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2 text-blue-400">Admin Analytics</h3>
              <p className="text-gray-400 text-sm">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold mt-4 text-blue-400">Frontend (Next.js 15.2.4)</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mt-4 text-blue-400">Backend APIs (Next.js API Routes)</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-400 mt-3">
            ...
            <div>
              <h3 className="text-lg font-semibold mt-4 text-blue-400">Authentication (NextAuth.js)</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-400 mt-3">
            ...
            <div>
              <h3 className="text-lg font-semibold mt-4 text-blue-400">Database (MongoDB)</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mt-4 text-blue-400">Payment Integration (Razorpay)</h3>
              <ul className="list-disc list-inside space-y-2 text-gray-400 mt-3">
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col items-center space-y-6 text-sm">
            <div className="w-full max-w-md border border-gray-700 rounded-lg p-4 text-center">
              <h3 className="font-semibold mb-2">Frontend (Next.js UI)</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="w-full max-w-md border border-gray-700 rounded-lg p-4 text-center">
              <h3 className="font-semibold mb-2">API Layer (Next.js Routes)</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="w-full max-w-md border border-gray-700 rounded-lg p-4 text-center">
              <h3 className="font-semibold mb-2">Authentication (NextAuth.js)</h3>
              <p className="text-gray-400 text-sm">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-semibold text-blue-400 mb-2">1. Authentication</h3>
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-semibold text-blue-400 mb-2">2. Product Browsing</h3>
              <p className="text-gray-400">
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-semibold text-blue-400 mb-2">3. Checkout & Payment</h3>
              <p className="text-gray-400">
            ...
            <div className="border-l-4 border-blue-500 pl-4">
              <h3 className="font-semibold text-blue-400 mb-2">4. Admin Dashboard</h3>
              <p className="text-gray-400">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-slate-900/40 border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold text-red-400 mb-2">Challenge: NextAuth.js OAuth Configuration</h3>
            ...
            <div className="bg-slate-900/40 border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold text-red-400 mb-2">Challenge: Razorpay Payment Integration</h3>
              <p className="text-gray-400 mb-3">
            ...
            <div className="bg-slate-900/40 border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold text-red-400 mb-2">Challenge: Cart Persistence Strategy</h3>
              <p className="text-gray-400 mb-3">
            ...
            <div className="bg-slate-900/40 border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold text-red-400 mb-2">Challenge: Admin Analytics Queries</h3>
              <p className="text-gray-400 mb-3">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold">Technical Implementation Highlights</h2>

          <div className="space-y-4">
            <div className="bg-slate-900/60 border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold text-white mb-2">Shopping Cart Logic</h3>
              <p className="text-gray-400 text-sm mb-2">
                Local Storage-based cart with real-time updates and quantity management.
              </p>
              <code className="text-blue-400 text-sm block bg-slate-950 p-2 rounded">
                localStorage.setItem('cart', JSON.stringify(cartItems))
              </code>
            </div>

            <div className="bg-slate-900/60 border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold text-white mb-2">Razorpay Checkout</h3>
              <p className="text-gray-400 text-sm mb-2">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold">Technical Learnings</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-400">
        ...
        <section className="space-y-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Product Reviews & Ratings</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              <h3 className="font-semibold mb-2">Wishlist Feature</h3>
              <p className="text-gray-400 text-sm">
