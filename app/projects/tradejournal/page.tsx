...
export const metadata: Metadata = {
  ...
  description:
    "Multi-market trading analytics platform with rule-based scoring, session analytics, and behavioral tracking across Equity, F&O, and Forex markets.",
  openGraph: {
    title: "TradeJournal Pro+ | Yash Parmar",
    description:
      "Multi-market trading analytics platform focused on risk discipline and structured performance tracking.",
    ...
    <main className="text-white min-h-screen pt-8">
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-10">
        ...
        <section className="space-y-6">
          <h1 className="text-4xl md:text-5xl font-black tracking-tight bg-gradient-to-r from-white via-white to-white/70 bg-clip-text text-transparent">
            TradeJournal Pro+
          </h1>

          <p className="text-lg text-gray-300 leading-relaxed">
            A multi-market trading analytics platform focused on risk
            discipline, behavioral consistency, and structured performance
            tracking across Equity, F&O, and Forex markets.
          </p>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mt-8">
            <div className="space-y-3">
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                ...
                <li>
                  <strong className="text-white">Authentication:</strong> JWT
                </li>
                <li>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-3 text-white/70 text-sm">
                <li>
                  <strong className="text-white">Role:</strong> Full-Stack
                  Developer
                </li>
                <li>
                  <strong className="text-white">Duration:</strong> Ongoing
                </li>
                <li>
        ...
        <section className="space-y-4">
          ...
          <p className="text-lg text-gray-300 leading-relaxed">
            TradeJournal Pro+ is a full-stack trading analytics platform
            designed to help traders measure not just profitability, but
            discipline and behavioral consistency. It integrates trade tracking,
            rule validation, session analytics, and performance segmentation
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-300 mt-4 mb-2 text-base">
                Indexed queries used for:
              </p>
              <ul className="list-disc list-inside space-y-3 text-gray-300 text-base ml-4">
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="w-full max-w-lg flex flex-col items-center">
              <div className="w-full rounded-xl p-6 text-center border border-white/[0.08] bg-gradient-to-b from-white/[0.06] to-white/[0.02] hover:border-teal-500/40 transition-all duration-300">
                ...
                <p className="text-gray-300 text-base leading-relaxed">
                  Handles trade entry, analytics visualization, and session
                  evaluation UI.
                </p>
              </div>
            ...
            <div className="w-full max-w-lg flex flex-col items-center">
              <div className="w-full rounded-xl p-6 text-center border border-white/[0.08] bg-gradient-to-b from-white/[0.06] to-white/[0.02] hover:border-teal-500/40 transition-all duration-300">
                ...
                <p className="text-gray-300 text-base leading-relaxed">
                  Processes trade data, executes rule evaluation logic, and
            ...
            <div className="w-full max-w-lg flex flex-col items-center">
              <div className="w-full rounded-xl p-6 text-center border border-white/[0.08] bg-gradient-to-b from-white/[0.06] to-white/[0.02] hover:border-teal-500/40 transition-all duration-300">
                <h3 className="font-bold text-lg mb-2">
                  Business Logic Layer (Risk Engine + Scoring Engine)
                </h3>
                <p className="text-gray-300 text-base leading-relaxed">
                  Implements risk validation, scoring engine, and analytics
                  aggregation.
                </p>
              </div>
              <div className="text-gray-500 text-2xl mt-4">↓</div>
            ...
            <div className="w-full max-w-lg">
              <div className="w-full rounded-xl p-6 text-center border border-white/[0.08] bg-gradient-to-b from-white/[0.06] to-white/[0.02] hover:border-teal-500/40 transition-all duration-300">
                <h3 className="font-bold text-lg mb-2">
                  Database Layer (MongoDB Collections + Aggregations)
                </h3>
                <p className="text-gray-300 text-base leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-3 text-gray-300 text-base leading-relaxed">
            <li>
              Handling floating point precision issues in financial calculations
              (P&L, Risk %, R-multiple).
            </li>
            <li>
              Designing a modular rule-based scoring engine for extensibility.
            </li>
            <li>
              Structuring MongoDB aggregation pipelines for session and strategy
              analytics.
            </li>
            <li>Maintaining UI state synchronization after trade mutations.</li>
            <li>
              Designing scalable schema relationships between trades, sessions,
              and evaluations.
            </li>
          </ul>
        </section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="list-disc list-inside space-y-3 text-gray-300 text-base mt-3">
                ...
                <li>
                  Designed to allow adding new rules without modifying
                  evaluation core.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-3 text-gray-300 text-base mt-3">
                ...
                <li>
                  Reduced computation on frontend by pre-processing in backend.
                </li>
              </ul>
            </div>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-3 text-gray-300 text-base leading-relaxed">
            <li>
              Planned deployment using Vercel (frontend) and Render/Node
              hosting.
            </li>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-3 text-gray-300 text-base leading-relaxed">
            ...
            <li>
              Structuring full-stack projects with long-term scalability in
              mind.
            </li>
          </ul>
        </section>
