    ...
    <Section id="education">
      ...
      >
        {educationData.map((edu) => (
          ...
          >
            {/* Card */}
            <div className="relative h-full flex flex-col overflow-hidden bg-gradient-to-b from-white/5 to-white/5 border border-white/10 rounded-2xl backdrop-blur-sm p-8 hover:border-teal-500/40 hover:from-white/10 hover:to-white/5 hover:shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-300">
              ...
              {/* Corner accent */}
              <div
                className={`absolute -bottom-6 -right-6 w-24 h-24 rounded-full bg-gradient-to-br ${edu.iconGradient} opacity-5 group-hover:opacity-10 transition-opacity duration-500 pointer-events-none`}
              />
              ...
              <div className="relative z-10 flex flex-col h-full gap-4">
                {/* Icon */}
                <div
                  className={`flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${edu.iconGradient} text-white shadow-lg shrink-0`}
                >
                  {edu.icon}
                </div>
                ...
                <div>
                  <span
                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full border text-xs font-medium ${edu.statusBg} ${edu.statusText} ${edu.statusBorder}`}
                  >
