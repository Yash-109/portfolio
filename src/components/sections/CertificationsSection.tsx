      ...
      >
        ...
        <div className="contents">
          {certificates.slice(0, 3).map((cert) => (
            ...
            >
              <div className="relative h-full flex flex-col bg-gradient-to-b from-white/5 to-white/5 border border-white/10 rounded-2xl backdrop-blur-sm p-8 overflow-hidden hover:border-teal-500/40 hover:from-white/10 hover:to-white/5 hover:shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-300">
                ...
                <div
                  className={`absolute -bottom-8 -right-8 w-32 h-32 rounded-full bg-gradient-to-br ${cert.gradient} opacity-5 group-hover:opacity-10 transition-opacity duration-500 pointer-events-none`}
                />
                ...
                <div className="relative z-10 flex flex-col h-full">
                  {/* Icon */}
                  <div
                    className={`w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br ${cert.gradient} text-white shadow-lg mb-5 shrink-0`}
                  >
                    {cert.icon}
                  </div>
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 lg:w-2/3 lg:mx-auto">
          {certificates.slice(3).map((cert) => (
            <motion.div
              ...
              className="group relative z-0 hover:z-10 h-full"
            >
              <div className="relative h-full flex flex-col bg-gradient-to-b from-white/5 to-white/5 border border-white/10 rounded-2xl backdrop-blur-sm p-8 overflow-hidden hover:border-teal-500/40 hover:from-white/10 hover:to-white/5 hover:shadow-[0_8px_32_rgba(0,0,0,0.3)] transition-all duration-300">
                <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-teal-500/0 via-teal-400 to-teal-500/0 rounded-t-2xl" />
